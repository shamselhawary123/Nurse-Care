  ...
  const services = ref([
    {
      ...
      description:
        "نوفر دعمًا شاملاً ورعاية متخصصة للأمهات والأطفال حديثي الولادة لضمان صحتهم وسلامتهم خلال الفترة الأولى الحاسمة.",
    ...
    },
    {
      ...
      description:
        "نقدم خدمات تمريضية منزلية متنوعة تشمل إعطاء الحقن، ومتابعة العلامات الحيوية، والعناية اليومية بالمرضى.",
    ...
    },
    {
      ...
      description:
        "نُقدم خدمة رعاية كبار السن في المنزل من خلال نُخبة من المتخصصين (ذكور/إناث) في التعامل مع كبار السن الذين يوفرون الرعاية الصحية والنفسية لهم.",
    ...
    },
    {
      ...
      description:
        "نوفر رعاية متخصصة للمرضى بعد العمليات الجراحية، مع متابعة دقيقة للجروح وتقديم الدعم اللازم لتعافٍ سريع.",
    ...
    },
    {
      ...
      description:
        "نوفر جلسات علاج طبيعي في المنزل على يد أفضل أخصائيي العلاج الطبيعي في مصر (ذكور/إناث) الذين يستخدمون أحدث الأساليب والأجهزة في العلاج الطبيعي.",
    ...
    },
    {
      ...
      description:
        "نوفر خدمة سحب العينات المخبرية من المنزل بسهولة ويسر، مع ضمان دقة النتائج وسرعة توصيلها.",
    ...
    },
    {
      ...
      description:
        "نقدم رعاية متقدمة ومتخصصة لعلاج قرح الفراش والوقاية منها، باستخدام أحدث المواد والتقنيات الطبية.",
    ...
    },
    {
      ...
      description:
        "يقوم فريقنا من الممرضين المحترفين بالعناية بالجروح المختلفة، بما في ذلك تغيير الضمادات وتقييم حالة الجرح.",
    ...
    <section class="services-section bg-background-soft py-16">
      <div class="container mx-auto px-4">
        <div class="text-center mb-12">
          <h1 class="text-4xl font-bold text-text-primary" data-aos="fade-up">
            خدمات Nurse-Care
          </h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          <div
            ...
            <div class="relative">
              ...
              <div class="absolute top-4 left-4">
                <img
                  src="/img/logo (3).png"
                  alt="Logo"
                  class="w-24 bg-surface p-2 rounded-lg shadow-md" />
              </div>
              <div class="absolute -bottom-8 left-1/2 -translate-x-1/2">
                <div
                  class="bg-primary rounded-full border-4 border-surface shadow-lg"
            ...
            <div class="p-6 pt-12 flex-grow flex flex-col text-center">
              ...
              <p
                class="text-text-secondary text-base leading-relaxed flex-grow">
                {{ service.description }}
              </p>

              <div class="mt-6 space-y-3">
                <button
                  @click="$router.push('/nurse-list')"
                  class="w-full bg-primary text-white py-3 rounded-lg font-semibold hover:bg-primary-hover transition-colors text-lg">
                  اطلب/استفسر عن الخدمة
                </button>
                <button
                  @click="navigateToService(service.title)"
                  class="w-full text-primary font-semibold hover:text-primary-hover transition-colors text-lg">
                  معلومات عن الخدمة
                </button>
              </div>
            </div>
      ...
      <div class="container mx-auto px-4 py-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div
            ...
            <h3
              class="text-xl font-semibold text-center mb-2 text-text-primary">
              {{ feature.title }}
            </h3>
